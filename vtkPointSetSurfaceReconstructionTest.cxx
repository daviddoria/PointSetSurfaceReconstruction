...
int main (int argc, char *argv[])
{
  ...
  //estimate normals
  vtkSmartPointer<vtkPointSetSurfaceReconstruction> surfaceReconstruction = vtkSmartPointer<vtkPointSetSurfaceReconstruction>::New();
  surfaceReconstruction->SetInput(InputReader->GetOutput());
  surfaceReconstruction->Update();
  
  vtkPolyData* surface = surfaceReconstruction->GetOutput();
  ...
  if(GroundTruthPolyData->GetNumberOfPoints() != surface->GetNumberOfPoints())
    {
    ...
    vtkstd::cout << "Input points: " << surface->GetNumberOfPoints() << vtkstd::endl;
    return EXIT_FAILURE;
    }
